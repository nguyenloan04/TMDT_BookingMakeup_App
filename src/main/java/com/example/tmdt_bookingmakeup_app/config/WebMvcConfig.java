...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(jwtHttpInterceptor)
                ...
                .excludePathPatterns("/auth/**", "/verification/**", "/search/**", "/users/{id:[a-fA-F0-9-]+}", "/promotions", "/promotions/{id:[a-fA-F0-9-]+}", "/promotions/validate", "/services", "/services/{id:[a-fA-F0-9-]+}", "/bookings/artist/**", "/profile/providers/**", "/reviews/service/{serviceId:[a-fA-F0-9-]+}", "/reviews/artist/{artistId:[a-fA-F0-9-]+}", "/ws/**", "/chat/rooms/**");
    }
    @Override
